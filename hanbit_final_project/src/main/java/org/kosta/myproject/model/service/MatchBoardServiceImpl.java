...
public class MatchBoardServiceImpl implements MatchBoardService {
   ...
   public List<Map<String, Object>> findAll(Criteria cri) {
	...
	/*
	 * @Override public int getTotalPostCountByCategory(MatchBoardVO matchBoardVO) {
	 * System.out.println(matchBoardVO); int count =
	 * matchBoardMapper.getTotalPostCountByCategory(matchBoardVO); return count; }
	 */
